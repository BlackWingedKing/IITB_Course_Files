...
entity righttestbench is
end entity;
architecture Behave of righttestbench is
...
begin
  process 
    ...
    File INFILE: text open read_mode is "../../righttrace.txt";
    FILE OUTFILE: text  open write_mode is "OUTPUTSr.txt";
