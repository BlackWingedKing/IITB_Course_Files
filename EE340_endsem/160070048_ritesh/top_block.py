...
# Title: Top Block
# Generated: Thu Nov  1 18:58:31 2018
##################################################
...
class top_block(grc_wxgui.top_block_gui):
    ...
    def __init__(self):
        ...
        self.rx_taps = rx_taps = firdes.root_raised_cosine(32,32*sps,1.0,0.35,1760)
        ...
        self.low_pass_filter_0_0 = filter.interp_fir_filter_fff(1, firdes.low_pass(
        	1, samp_rate, 25e3, 100, firdes.WIN_HAMMING, 6.76))
        ...
        self.blocks_file_source_0 = blocks.file_source(gr.sizeof_float*1, "/home/ritesh/Desktop/EE340_endsem/Q2.dat", True)
        ...
        self.connect((self.dc_blocker_xx_0_0, 0), (self.rational_resampler_xxx_0_0, 0))    
    ...
    def set_sps(self, sps):
        self.sps = sps
        self.set_rx_taps(firdes.root_raised_cosine(32,32*self.sps,1.0,0.35,1760))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.low_pass_filter_0.set_taps(firdes.low_pass(1, self.samp_rate, 25e3, 100, firdes.WIN_HAMMING, 6.76))
        self.low_pass_filter_0_0.set_taps(firdes.low_pass(1, self.samp_rate, 25e3, 100, firdes.WIN_HAMMING, 6.76))
